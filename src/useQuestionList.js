    ...
    const [questionList, setQuestionList] = useState([
        // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
        {
            ...
            groupContents: [{
                    ...
                    answerImg: [halluxValgusTreatment1,halluxValgusTreatment2,halluxValgusArthrodesis],
                    answer: '可動域の消失,やや長い術後経過',
                    commentary: '重度の外反母趾に対しては関節固定術が適応される。完全に関節を固定してしまうので、可動性の消失や手術後しばらくの歩行補助器具(やや長い術後経過)がデメリットとなるが、他の治療法と比較すると良好な除痛が見込めるほか、他の関節が動きを補ってくれるため運動能力の獲得や安定性の再獲得が期待できる。選択肢は全て正しく、デメリットを選択する問題である。',
                },{
                    detailInfo: '14. AI正解',
                    questionImg: [],
