...
,{
        ...
        groupContents: [{
            ...
            answer: '免疫抑制剤としてシクロスポリンとタクロリムスを併用する。',
            commentary: '臍帯血移植は小児での施行件数が多い(小児のドナーが少ないことが関係する)。GVHDが発症するとGVL効果(移植免疫が白血病細胞も攻撃する)が期待できるため再発率は下がる。骨髄バンクの登録は55歳までであるが、実際の移植は60歳~65歳程度まで受けることができる。サイトメガロウイルスは移植定着後(30-100日)にもっとも頻度が高い。'
        },{
            detailInfo: '2.',
            questionImg: [],
