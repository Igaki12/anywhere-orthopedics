...
// {
    ...
    // }
    {
        ...
        groupContents: [{
            ...
            answerImg: [],
            answer: 'T細胞',
            commentary: '移植後24時間以内に発症する。 免疫抑制剤の投与が効かないため、発症した場合は移植した臓器を迅速に摘出する治療法が選択される。具体的な症状は血栓形成、臓器虚血。この過程は既存の体液性免疫によるものであるため、免疫抑制剤で抑制を行うことができない。　→T細胞による免疫反応ではない。'
        },{
            detailInfo: '11.',
            questionImg: [],
            ...
            answer: '4,5',
            commentary: 'ALLにおける造血幹細胞移植は最後の治療方法であり、まずステロイドや抗がん剤、分子標的薬などによる薬物療法が優先される。第1寛解期での移植は、超高危険群やMRD陽性(→治療抵抗性)の場合にだけ行われる。難治例や再発例では造血幹細胞移植が適応となるが、寛解に至っていない場合の移植成績は非常に悪い(約20%)。予後不良因子として年齢・白血球数・ステロイド反応性・T細胞性・遺伝子異常などの要素があり、Ph+型やKMT2A-regenerated型などは頻度は低いが予後不良因子に分類され、5年無病生存率は64~76%程度である(細かすぎる)。2の選択肢については、成人では間違いなく移植推奨条件であるが、「2年再発しなければ薬が一応効いたということで薬物治療を続ける」というようなことを言っていた気がするし、小児の移植は成人と比べて若干適応範囲が狭いので今回は誤りとした。いずれにしても数字が非常にシビアでこれ以上調べる気分にならない...。'
        },{
            detailInfo: '25.',
            questionImg: [],
            ...
            commentary: '褥瘡とは、体と支持面との接触部位で皮膚が圧迫されて起こる血行障害が一定期間持続し組織壊死に至ったものである。後発部位は皮下組織が薄く外力が集中しやすい骨突出部で、仰臥位では仙骨部、側臥位では腸骨部、大転子部で多い。褥瘡は感染しやすいので、発症直後から感染に注意する。坐骨部の褥瘡は坐位や車いす坐位が続く場合に発症しやすく、広い麻痺であるほど発症しやすい。褥瘡創面から出る滲出液はタンパク質を多量に含んでいるので、低タンパク血症だと治癒が遅れ褥瘡になりやすいが、褥瘡によって低タンパク血症になったという症例は見つからなかった(そもそも血行が悪いので体液流出は少ない)。肉芽組織でも血流があるので褥瘡ができることがある。'
        },{
            detailInfo: '33.',
            questionImg: [],
