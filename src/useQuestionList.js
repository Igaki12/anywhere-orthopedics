...
// {
        ...
        groupContents: [{
            ...
            commentary: '人工膝関節置換術後の周術期合併症の肺血栓塞栓症については、術後24時間以内の発症が多い。深部静脈血栓症の既往がある場合は発症頻度が高い。予防策として下肢弾性ストッキングの装着がある。起立、 歩行開始時に突然の呼吸困難と胸痛を主訴に発症することがある。予防として足関節の底背屈運動が有効である。',
        },{
            detailInfo: '17.',
            questionImg: [],
            questionSentence: '骨端症について正しいものを2つ選べ。',
